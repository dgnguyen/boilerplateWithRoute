  ...
  <div className="rightContainer">
    ...
    <div className="socialIcons">
      ...
      <div className="pagination">
        <div className="pageNumber" style={{color:"#F1D145", fontSize:"70px", fontFamily:"Acumin Pro"}}>{page === "pieapple" ?  1 : 2} </div><span style={{color:"#375238", fontSize:"30px", fontFamily:"Acumin Pro"}}>/ 2</span>
